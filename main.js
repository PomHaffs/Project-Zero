...
new Audio("audio/BED.m4a"),
new Audio("audio/DISAPPOINTING.m4a"),
new Audio("audio/DRESS.m4a"),
new Audio("audio/FRONT.m4a"),
new Audio("audio/LEGAL.m4a"),
new Audio("audio/RUNNING.m4a"),
new Audio("audio/SEEN.m4a"),
new Audio("audio/SHE.m4a"),
new Audio("audio/SUCCESS.m4a"),
new Audio("audio/BRUSH.m4a"),
new Audio("audio/WHERE.m4a"),
new Audio("audio/BITE.m4a"),
new Audio("audio/FUCK.m4a"),
new Audio("audio/HAIRY.m4a"),
new Audio("audio/TICK.m4a"),
